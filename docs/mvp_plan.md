...
The current Godot prototype is a western arena survival game: one sandy courthouse courtyard, one-hit player tension, sword and revolver combat, outlaw skills, wave pressure, and human enemy archetypes.
...
- Gunplay: add a player revolver with ammo and reload loops that support close-range sword pressure.
